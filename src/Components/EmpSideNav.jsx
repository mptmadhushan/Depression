...
const navLinks = [
  ...
  {
      cat: "Employee Activities",
      listname : "Employee Activities",
      name: "Employee Activities",
      state: "isActiveEmployeeActivities",
      icon: "WheelchairPickup",
      link: "EmployeeActivities",
    },
  ...
  <div className={`flex  ${isSideNavOpen ? "sidenav-open" : ""}`}>
    ...
    z-20 w-full backdrop-blur-md bg-opacity-90 sm:bg-opacity-100 sm:backdrop-blur-0 overflow-y-scroll sm:overflow-hidden ${isSideNavOpen ? "sidenav-open" : ""}`}>
      ...
      <ul className="flex flex-col w-full space-y-3 ">
        ...
        <div className="music-player w-full  h-auto p-3 rounded-lg flex items-center">
<MusicPlayer/>
       </div>
