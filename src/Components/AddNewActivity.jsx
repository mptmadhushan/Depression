        ...
        <div className="w-full h-screen fixed p-5 flex justify-center items-center bg-gray-400 backdrop-blur-md bg-opacity-30 z-20">
            <div className="w-[70%] bg-white rounded-md h-auto p-5 flex flex-col space-y-3">
                <div className="flex flex-row justify-between">
                    <h3 className="text-[#151515] text-[1.3rem] ">Add New Activity</h3>
                    <div className="mr-5">
 ...
 */}
                    ...
                    <div className="d-card p-3 flex justify-center items-left flex-col w-full space-y-3">
                        <h3 className="text-[#151515] text-[1rem] font-semibold text-left">Recommended Activities</h3>
                        <div className="w-full rounded-md border-gray-200 border-[1px] p-2">
                            <span>Activity</span>
                        </div>
                    </div>
                    ...
                    <div className='flex flex-row w-full justify-end space-x-5'>
                            <button className="text-white text-[1rem] bg-[#5C3BB9]  py-2 px-2 rounded-md w-[128px]">Add</button>
