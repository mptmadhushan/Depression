...
import { faMicrophoneLines,faMicrophoneSlash, faPaperPlane,  faMicrophone } from "@fortawesome/free-solid-svg-icons";
...
const ChatBot = () => {
    ...
    return (
        ...
        <div className="justify-end fixed top-0">
            ...
            <div
                className={`chat-messenger relative ${isChatOpen ? "open" : "closed"
    ...
    <button
        className={`w-1/2 text-white p-2 ${
          activeButton === 'DASS21' ? 'bg-[#5C3BB9]' : 'bg-[#5C3BB9] opacity-40'
        }`}
      ...
      <button
        className={`w-1/2 text-white p-2 ${
          activeButton === 'Chat Agent' ? 'bg-[#5C3BB9]' : 'bg-[#5C3BB9] opacity-40'
        }`}
      ...
      >
        Chat Agent
            ...
            />
              ...
              >
                <FontAwesomeIcon
                  ...
                  className={`text-white ${isVoiceInputActive ? "text-red-200" : ""}`}
                />
              </button>
            ...
            <div
                className={`bot-icon h-[200px] ${isChatOpen ? "open" : "closed"
                    } fixed z-50 `}
            >
                <img
